    ...
    <main className="font-poppins bg-Primary text-black select-none">
      <section className="min-h-screen flex justify-center items-center">
        <div className="flex justify-center items-center flex-col gap-16">
          <figure className="uppercase font-bold text-3xl">
            logo
          </figure>
          ...
          <article className="flex flex-col gap-8">
            <div className="flex flex-row justify-center items-center gap-4 bg-Tertiary py-3 px-5 rounded-2xl shadow-xl">
              <Link
                to="/registerAdoptador"
              >
